...
<template>
  <div class="flex flex-col lg:space-y-6 xl:px-20 space-y-4">
    ...
    <div
      class="grid lg:grid-cols-4 lg:gap-16 grid-cols-2 gap-4 w-full self-center"
    >
      <div
      ...
      >
        ...
        <h1 class="md:w-40 w-32 ">{{ service.title }}</h1>
      </div>
    </div>
  </div>
</template>
